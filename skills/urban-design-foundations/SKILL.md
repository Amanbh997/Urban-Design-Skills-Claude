...
description: >-
  Comprehensive urban design knowledge base containing theories, principles,
  quantitative standards, and rules of thumb from 40+ theorists and global
  frameworks. Provides foundational knowledge for all urban design tasks
  including masterplanning, site analysis, street design, public space design,
  density calculations, and sustainability assessment. Automatically activates
  whenever the conversation involves urban design, city planning, urban
  morphology, placemaking, walkability, transit-oriented development, mixed-use
  development, zoning, building typologies, streetscapes, public realm,
  neighborhood design, district planning, or any AEC topic at the urban scale.
  Covers Kevin Lynch, Jane Jacobs, Christopher Alexander, Jan Gehl, Gordon
  Cullen, Camillo Sitte, Andres Duany, Leon Krier, Ian Bentley, New Urbanism,
  Smart Growth, Complete Streets, 15-Minute City, Space Syntax, CPTED, and
  all major sustainability certifications.
...
1. Protection against traffic and accidents - feeling safe from vehicles, separated pedestrian zones, low vehicle speeds
2. Protection against crime and violence - natural surveillance, good lighting, active ground floors, clear sightlines
3. Protection against unpleasant sensory experiences - wind protection, rain/snow shelter, excessive heat/cold mitigation, pollution reduction, noise buffering
...
1. **Permeability** - number and quality of alternative routes through an area; maximize visual and physical permeability; small blocks, frequent intersections, mid-block passages
2. **Variety** - range of uses, building types, and experiences available; diversity of activities at different times of day; mixed tenure and price points
3. **Legibility** - ease of understanding the spatial structure; clear hierarchy of routes, distinct districts, visible landmarks, meaningful nodes
4. **Robustness** - capacity of spaces and buildings to serve different purposes and adapt over time; flexible floor plates, adaptable ground floors, multi-use public spaces
5. **Visual Appropriateness** - buildings and spaces communicate their role and meaning through form, materials, and details; civic buildings look civic, homes look domestic
6. **Richness** - variety of sensory experiences through materials, textures, colors, sounds, smells, planting, water, light and shadow patterns, seasonal changes
7. **Personalization** - degree to which users can modify and put their own stamp on spaces and buildings; balconies, front gardens, shopfront individuality, community murals

### PPS 4 Qualities of Great Places
1. **Access and Linkages** - visible from a distance, easy to get to and walk through, connected to adjacent areas, accessible by transit, bike, and foot, well-connected internally
2. **Comfort and Image** - safe and clean, available seating, attractive and well-maintained, good reputation, comfortable microclimate
3. **Uses and Activities** - reasons to be there at all times, vital and active, unique and special, fun and interesting, programmed events, community uses
4. **Sociability** - diverse mix of people, sense of neighborliness, interactive and welcoming, sense of pride and ownership, cooperative management

### Healthy Streets 10 Indicators (Transport for London)
1. **Pedestrians from all walks of life** - inclusivity across age, ability, gender, ethnicity, and income
2. **Easy to cross** - short wait times, direct desire-line crossings, pedestrian priority, minimal crossing distances
3. **Shade and shelter** - protection from sun, rain, wind, and snow through trees, canopies, arcades, and building overhangs
4. **Places to stop and rest** - benches, leaning rails, and rest points spaced at regular intervals (every 50-100m for elderly/disabled)
5. **Not too noisy** - ambient noise below 70 dB(A) for comfortable conversation, ideally below 60 dB(A)
6. **People choose to walk, cycle, and use public transport** - mode share targets favoring active and sustainable transport
7. **People feel safe** - adequate lighting, sightlines, active frontages, other people present, no entrapment spots
8. **Things to see and do** - active frontages, window displays, public art, street performers, markets, visual interest at eye level
9. **People feel relaxed** - greenery, water features, calm traffic, clean air, absence of visual clutter and aggressive advertising
10. **Clean air** - pollutant levels below WHO guidelines, tree planting for filtration, low-emission zones, traffic reduction
...
- **Action:** Invoke the `site-analysis` skill for detailed site assessment methodology, checklist, and evaluation criteria
...
- **Action:** Invoke the `design-evaluation` skill for structured evaluation frameworks, scoring rubrics, and comparative analysis methods
...
- **Action:** Invoke the `masterplan-design` skill for masterplanning methodology, spatial structuring principles, and design generation workflows
...
- **Action:** Invoke the `street-design` skill for NACTO-aligned street design standards, cross-section templates, and intersection design guidance
...
- **Action:** Invoke the `public-space-design` skill for public space typologies, programming guidance, microclimate design, and furnishing standards
...
- **Action:** Invoke the `block-and-density` skill for block configuration strategies, density calculation methods, and building typology-to-density relationships
...
- **Action:** Invoke the `mixed-use-programming` skill for use mix optimization, demand calculations, synergy matrices, and program distribution strategies
...
- **Action:** Invoke the `tod-design` skill for TOD typologies, station area planning, density gradient strategies, and ITDP scoring methodology
...
- **Action:** Invoke the `climate-responsive-design` skill for climate-specific design strategies, microclimate analysis methods, and green infrastructure sizing
...
- **Action:** Invoke the `zoning-and-codes` skill for zoning interpretation methods, form-based code structure, and regulatory compliance strategies
...
- **Action:** Invoke the `sustainability-scoring` skill for certification credit-by-credit guidance, point optimization strategies, and documentation requirements
...
- **Action:** Invoke the `precedent-study` skill for precedent databases, analytical frameworks, and transferable lesson extraction
...
- See [theorists-and-movements.md](references/theorists-and-movements.md)
...
- See [quantitative-standards.md](references/quantitative-standards.md)
...
- See [global-frameworks.md](references/global-frameworks.md)
...
- See [rules-of-thumb.md](references/rules-of-thumb.md)
